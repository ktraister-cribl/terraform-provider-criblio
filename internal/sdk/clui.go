...
func newClui(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Clui {
	return &Clui{
		rootSDK:          rootSDK,
...
// GetClui - Get CLUI search results
// Get CLUI search results
func (s *Clui) GetClui(ctx context.Context, request operations.GetCluiRequest, opts ...operations.Option) (*operations.GetCluiResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/clui")
	if err != nil {
	...
	res := &operations.GetCluiResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetCluiResponseBody
