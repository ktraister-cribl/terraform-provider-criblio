...
// FileSampler - Actions related to FileSampler
...
func newFileSampler(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *FileSampler {
	return &FileSampler{
		rootSDK:          rootSDK,
...
func (s *FileSampler) GetEdgeFileSample(ctx context.Context, request operations.GetEdgeFileSampleRequest, opts ...operations.Option) (*operations.GetEdgeFileSampleResponse, error) {
