...
// Processes - Actions related to Processes
...
func newProcesses(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Processes {
	return &Processes{
		rootSDK:          rootSDK,
...
// GetSystemProcesses - Get a list of processes under management
// Get a list of processes under management
func (s *Processes) GetSystemProcesses(ctx context.Context, opts ...operations.Option) (*operations.GetSystemProcessesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/system/processes")
	if err != nil {
	...
	res := &operations.GetSystemProcessesResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetSystemProcessesResponseBody
