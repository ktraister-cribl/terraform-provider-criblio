...
// Generated from OpenAPI doc version 4.12.2-4b17c8d4 and generator version 2.674.1
...
func New(opts ...SDKOption) *CriblIo {
	sdk := &CriblIo{
		SDKVersion: "1.4.5",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 1.4.5 2.674.1 4.12.2-4b17c8d4 github.com/criblio/terraform-provider-criblio/internal/sdk",
