...
// Generated from OpenAPI doc version 4.12.2-4b17c8d4 and generator version 2.670.3
...
func New(opts ...SDKOption) *CriblIo {
	sdk := &CriblIo{
		SDKVersion: "1.3.28",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 1.3.28 2.670.3 4.12.2-4b17c8d4 github.com/criblio/terraform-provider-criblio/internal/sdk",
