...
// Generated from OpenAPI doc version 4.12.2-4b17c8d4-TFProvider-manual and generator version 2.654.2
...
func New(opts ...SDKOption) *CriblIo {
	sdk := &CriblIo{
		SDKVersion: "1.0.45",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 1.0.45 2.654.2 4.12.2-4b17c8d4-TFProvider-manual github.com/speakeasy/terraform-provider-criblio/internal/sdk",
