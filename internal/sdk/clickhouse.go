...
// ClickHouse - Actions related to ClickHouse
...
func newClickHouse(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ClickHouse {
	return &ClickHouse{
		rootSDK:          rootSDK,
...
// CreateOutputClickHouseDescribeTable - Retrieve the description of the configured ClickHouse table
// Retrieve the description of the configured ClickHouse table
func (s *ClickHouse) CreateOutputClickHouseDescribeTable(ctx context.Context, request shared.CHOutConfig, opts ...operations.Option) (*operations.CreateOutputClickHouseDescribeTableResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/output/click-house/describe-table")
	if err != nil {
	...
	res := &operations.CreateOutputClickHouseDescribeTableResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.CreateOutputClickHouseDescribeTableResponseBody
