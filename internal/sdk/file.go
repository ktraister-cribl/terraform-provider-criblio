...
func newFile(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *File {
	return &File{
		rootSDK:          rootSDK,
...
func (s *File) CreateEdgeFileIngest(ctx context.Context, request operations.CreateEdgeFileIngestRequest, opts ...operations.Option) (*operations.CreateEdgeFileIngestResponse, error) {
