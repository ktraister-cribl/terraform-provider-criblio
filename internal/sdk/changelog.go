...
// Changelog - Actions related to Changelog
...
func newChangelog(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Changelog {
	return &Changelog{
		rootSDK:          rootSDK,
...
// GetChangelogViewed - Get changelog viewed state
// Get changelog viewed state
func (s *Changelog) GetChangelogViewed(ctx context.Context, opts ...operations.Option) (*operations.GetChangelogViewedResponse, error) {
	...
	res := &operations.GetChangelogViewedResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetChangelogViewedResponseBody
