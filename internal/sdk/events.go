...
// Events - Actions related to Events
type Events struct {
	rootSDK          *CriblIo
...
func newEvents(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Events {
	return &Events{
		rootSDK:          rootSDK,
...
// GetEdgeEventsQuery - Get events generated by a specified source
// Get events generated by a specified source
func (s *Events) GetEdgeEventsQuery(ctx context.Context, request operations.GetEdgeEventsQueryRequest, opts ...operations.Option) (*operations.GetEdgeEventsQueryResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/edge/events/query")
	if err != nil {
	...
	res := &operations.GetEdgeEventsQueryResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetEdgeEventsQueryResponseBody
