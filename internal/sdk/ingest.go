...
// Ingest - Actions related to Ingest
type Ingest struct {
	rootSDK          *CriblIo
...
func newIngest(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Ingest {
	return &Ingest{
		rootSDK:          rootSDK,
...
func (s *Ingest) CreateEdgeFileIngest(ctx context.Context, request operations.CreateEdgeFileIngestRequest, opts ...operations.Option) (*operations.CreateEdgeFileIngestResponse, error) {
