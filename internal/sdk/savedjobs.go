...
func newSavedJobs(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SavedJobs {
	return &SavedJobs{
		rootSDK:          rootSDK,
...
func (s *SavedJobs) CreateSavedJob(ctx context.Context, request operations.CreateSavedJobRequest, opts ...operations.Option) (*operations.CreateSavedJobResponse, error) {
	...
	res := &operations.CreateSavedJobResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.CreateSavedJobResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *SavedJobs) GetSavedJobByID(ctx context.Context, request operations.GetSavedJobByIDRequest, opts ...operations.Option) (*operations.GetSavedJobByIDResponse, error) {
	...
	res := &operations.GetSavedJobByIDResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetSavedJobByIDResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
