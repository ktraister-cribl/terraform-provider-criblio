...
func newInvoices(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Invoices {
	return &Invoices{
		rootSDK:          rootSDK,
...
func (s *Invoices) V5BillingInvoicesGetInvoices(ctx context.Context, request operations.V5BillingInvoicesGetInvoicesRequest, opts ...operations.Option) (*operations.V5BillingInvoicesGetInvoicesResponse, error) {
	...
	res := &operations.V5BillingInvoicesGetInvoicesResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.GetInvoicesResponseV5
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetInvoicesResponseV5 = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Invoices) V5BillingInvoicesGetInvoice(ctx context.Context, request operations.V5BillingInvoicesGetInvoiceRequest, opts ...operations.Option) (*operations.V5BillingInvoicesGetInvoiceResponse, error) {
	...
	res := &operations.V5BillingInvoicesGetInvoiceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.GetInvoiceResponseV5
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetInvoiceResponseV5 = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
