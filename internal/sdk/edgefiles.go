...
// EdgeFiles - Actions related to Edge Files
...
func newEdgeFiles(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *EdgeFiles {
	return &EdgeFiles{
		rootSDK:          rootSDK,
...
func (s *EdgeFiles) GetEdgeFileinspect(ctx context.Context, opts ...operations.Option) (*operations.GetEdgeFileinspectResponse, error) {
