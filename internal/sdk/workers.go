...
func newWorkers(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Workers {
	return &Workers{
		rootSDK:          rootSDK,
...
func (s *Workers) GetSummaryWorkers(ctx context.Context, request operations.GetSummaryWorkersRequest, opts ...operations.Option) (*operations.GetSummaryWorkersResponse, error) {
