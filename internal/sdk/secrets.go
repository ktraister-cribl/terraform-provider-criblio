...
func newSecrets(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Secrets {
	return &Secrets{
		rootSDK:          rootSDK,
...
func (s *Secrets) ListRestSecret(ctx context.Context, opts ...operations.Option) (*operations.ListRestSecretResponse, error) {
	...
	res := &operations.ListRestSecretResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListRestSecretResponseBody
...
func (s *Secrets) CreateRestSecret(ctx context.Context, request shared.RestSecret, opts ...operations.Option) (*operations.CreateRestSecretResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.CreateRestSecretResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
// GetRestSecretByID - Get RestSecret by ID
// Get RestSecret by ID
func (s *Secrets) GetRestSecretByID(ctx context.Context, request operations.GetRestSecretByIDRequest, opts ...operations.Option) (*operations.GetRestSecretByIDResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	res := &operations.GetRestSecretByIDResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetRestSecretByIDResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
// UpdateRestSecretByID - Update RestSecret
// Update RestSecret
func (s *Secrets) UpdateRestSecretByID(ctx context.Context, request operations.UpdateRestSecretByIDRequest, opts ...operations.Option) (*operations.UpdateRestSecretByIDResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	res := &operations.UpdateRestSecretByIDResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.UpdateRestSecretByIDResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
// DeleteRestSecretByID - Delete RestSecret
// Delete RestSecret
func (s *Secrets) DeleteRestSecretByID(ctx context.Context, request operations.DeleteRestSecretByIDRequest, opts ...operations.Option) (*operations.DeleteRestSecretByIDResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	res := &operations.DeleteRestSecretByIDResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.DeleteRestSecretByIDResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
