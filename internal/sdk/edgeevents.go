...
// EdgeEvents - Actions related to EdgeEvents
...
func newEdgeEvents(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *EdgeEvents {
	return &EdgeEvents{
		rootSDK:          rootSDK,
...
func (s *EdgeEvents) GetEdgeEventsCollectors(ctx context.Context, opts ...operations.Option) (*operations.GetEdgeEventsCollectorsResponse, error) {
