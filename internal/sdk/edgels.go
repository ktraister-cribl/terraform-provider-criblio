...
// EdgeLs - Actions related to Edge listing
type EdgeLs struct {
	rootSDK          *CriblIo
...
func newEdgeLs(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *EdgeLs {
	return &EdgeLs{
		rootSDK:          rootSDK,
...
func (s *EdgeLs) GetEdgeLsByPath(ctx context.Context, request operations.GetEdgeLsByPathRequest, opts ...operations.Option) (*operations.GetEdgeLsByPathResponse, error) {
