...
// TrustPolicies - Actions related to Trust Policies
...
func newTrustPolicies(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *TrustPolicies {
...
// ListTrustPolicy - Get a list of TrustPolicy objects
// Get a list of TrustPolicy objects
func (s *TrustPolicies) ListTrustPolicy(ctx context.Context, opts ...operations.Option) (*operations.ListTrustPolicyResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/search/trust-policies")
	if err != nil {
	...
	res := &operations.ListTrustPolicyResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListTrustPolicyResponseBody
