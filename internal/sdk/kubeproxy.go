...
// KubeProxy - Actions related to Kube Proxy
...
func newKubeProxy(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *KubeProxy {
	return &KubeProxy{
		rootSDK:          rootSDK,
...
func (s *KubeProxy) GetEdgeKubeProxy(ctx context.Context, request operations.GetEdgeKubeProxyRequest, opts ...operations.Option) (*operations.GetEdgeKubeProxyResponse, error) {
