...
// Consent - Actions related to Consent
type Consent struct {
	rootSDK          *CriblIo
...
func newConsent(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Consent {
	return &Consent{
		rootSDK:          rootSDK,
...
// GetAiConsent - Fetches the AI consent information, specifically the org GUID and accepted boolean.
// Fetches the AI consent information, specifically the org GUID and accepted boolean.
func (s *Consent) GetAiConsent(ctx context.Context, opts ...operations.Option) (*operations.GetAiConsentResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/ai/consent")
	if err != nil {
	...
	res := &operations.GetAiConsentResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetAiConsentResponseBody
...
// CreateAiConsent - Stores the AI consent information, specifically the org GUID and accepted boolean.
// Stores the AI consent information, specifically the org GUID and accepted boolean.
func (s *Consent) CreateAiConsent(ctx context.Context, opts ...operations.Option) (*operations.CreateAiConsentResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.CreateAiConsentResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.CreateAiConsentResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
