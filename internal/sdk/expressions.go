...
func newExpressions(rootSDK *CriblIo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Expressions {
	return &Expressions{
		rootSDK:          rootSDK,
...
// CreateLibExpression - Evaluate JavaScript expression
// Evaluate JavaScript expression
func (s *Expressions) CreateLibExpression(ctx context.Context, opts ...operations.Option) (*operations.CreateLibExpressionResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/lib/expression")
	if err != nil {
	...
	res := &operations.CreateLibExpressionResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.CreateLibExpressionResponseBody
