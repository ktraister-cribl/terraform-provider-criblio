...
type OutputDynatraceOtlp struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderHTTP      `tfsdk:"extra_http_headers"`
	...
	Metadata                      []OutputMetadatumHTTP      `tfsdk:"metadata"`
	...
	PqControls                    *PqControlsHTTP            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingHTTP `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String             `tfsdk:"safe_headers"`
	Status                        *TFStatus                  `tfsdk:"status"`
	Streamtags                    []types.String             `tfsdk:"streamtags"`
	SystemFields                  []types.String             `tfsdk:"system_fields"`
	TimeoutRetrySettings          *TimeoutRetrySettingsHTTP  `tfsdk:"timeout_retry_settings"`
