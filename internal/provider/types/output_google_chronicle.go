...
type OutputGoogleChronicle struct {
	...
	ExtraHTTPHeaders                []ExtraHTTPHeaderGoogleChronicle      `tfsdk:"extra_http_headers"`
	...
	PqControls                      *PqControlsGoogleChronicle            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings           []ResponseRetrySettingGoogleChronicle `tfsdk:"response_retry_settings"`
	...
	TimeoutRetrySettings            *TimeoutRetrySettingsGoogleChronicle  `tfsdk:"timeout_retry_settings"`
