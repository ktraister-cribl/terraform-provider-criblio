...
type OutputDatadog struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderDatadog      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsDatadog            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingDatadog `tfsdk:"response_retry_settings"`
	...
	TimeoutRetrySettings          *TimeoutRetrySettingsDatadog  `tfsdk:"timeout_retry_settings"`
