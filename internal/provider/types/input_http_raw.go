...
type InputHTTPRaw struct {
	...
	AuthTokensExt         []AuthTokensExtHTTPRaw        `tfsdk:"auth_tokens_ext"`
	BreakerRulesets       []types.String                `tfsdk:"breaker_rulesets"`
	CaptureHeaders        types.Bool                    `tfsdk:"capture_headers"`
	Connections           []ConnectionHTTPRaw           `tfsdk:"connections"`
	...
	Metadata              []MetadatumHTTPRaw            `tfsdk:"metadata"`
	Pipeline              types.String                  `tfsdk:"pipeline"`
	Port                  types.Float64                 `tfsdk:"port"`
	Pq                    *PqHTTPRaw                    `tfsdk:"pq"`
	...
	TLS                   *TLSSettingsServerSideHTTPRaw `tfsdk:"tls"`
