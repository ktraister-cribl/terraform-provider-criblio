...
type InputHTTPRaw struct {
	...
	AuthTokensExt         []InputHTTPRawAuthTokensExt        `tfsdk:"auth_tokens_ext"`
	BreakerRulesets       []types.String                     `tfsdk:"breaker_rulesets"`
	CaptureHeaders        types.Bool                         `tfsdk:"capture_headers"`
	Connections           []InputHTTPRawConnection           `tfsdk:"connections"`
	...
	Metadata              []InputHTTPRawMetadatum            `tfsdk:"metadata"`
