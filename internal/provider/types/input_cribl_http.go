...
type InputCriblHTTP struct {
	...
	Connections           []ConnectionCriblHTTP           `tfsdk:"connections"`
	...
	Metadata              []MetadatumCriblHTTP            `tfsdk:"metadata"`
	Pipeline              types.String                    `tfsdk:"pipeline"`
	Port                  types.Float64                   `tfsdk:"port"`
	Pq                    *PqCriblHTTP                    `tfsdk:"pq"`
	...
	TLS                   *TLSSettingsServerSideCriblHTTP `tfsdk:"tls"`
