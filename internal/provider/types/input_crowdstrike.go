...
type InputCrowdstrike struct {
	...
	Checkpointing           *CheckpointingCrowdstrike `tfsdk:"checkpointing"`
	Connections             []ConnectionCrowdstrike   `tfsdk:"connections"`
	...
	Metadata                []MetadatumCrowdstrike    `tfsdk:"metadata"`
	NumReceivers            types.Float64             `tfsdk:"num_receivers"`
	Pipeline                types.String              `tfsdk:"pipeline"`
	PollTimeout             types.Float64             `tfsdk:"poll_timeout"`
	Pq                      *PqCrowdstrike            `tfsdk:"pq"`
	PqEnabled               types.Bool                `tfsdk:"pq_enabled"`
	Preprocess              *PreprocessCrowdstrike    `tfsdk:"preprocess"`
