...
type InputCriblLakeHTTP struct {
	...
	Connections           []InputCriblLakeHTTPConnection           `tfsdk:"connections"`
	...
	Metadata              []InputCriblLakeHTTPMetadatum            `tfsdk:"metadata"`
	Pipeline              types.String                             `tfsdk:"pipeline"`
	Port                  types.Float64                            `tfsdk:"port"`
	Pq                    *InputCriblLakeHTTPPq                    `tfsdk:"pq"`
	...
	TLS                   *InputCriblLakeHTTPTLSSettingsServerSide `tfsdk:"tls"`
