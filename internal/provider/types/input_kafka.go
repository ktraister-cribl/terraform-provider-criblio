...
type InputKafka struct {
	...
	Connections               []ConnectionKafka                            `tfsdk:"connections"`
	...
	KafkaSchemaRegistry       *InputKafkaSchemaRegistryAuthenticationKafka `tfsdk:"kafka_schema_registry"`
	...
	Metadata                  []MetadatumKafka                             `tfsdk:"metadata"`
	...
	Sasl                      *InputAuthenticationKafka                    `tfsdk:"sasl"`
	SendToRoutes              types.Bool                                   `tfsdk:"send_to_routes"`
	SessionTimeout            types.Float64                                `tfsdk:"session_timeout"`
	Status                    *TFStatus                                    `tfsdk:"status"`
	Streamtags                []types.String                               `tfsdk:"streamtags"`
	TLS                       *InputTLSSettingsClientSideKafka             `tfsdk:"tls"`
