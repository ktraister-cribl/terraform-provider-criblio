...
type InputKafka struct {
	...
	Connections               []InputKafkaConnection                       `tfsdk:"connections"`
	...
	KafkaSchemaRegistry       *InputKafkaKafkaSchemaRegistryAuthentication `tfsdk:"kafka_schema_registry"`
	...
	Metadata                  []InputKafkaMetadatum                        `tfsdk:"metadata"`
	Pipeline                  types.String                                 `tfsdk:"pipeline"`
	Pq                        *InputKafkaPq                                `tfsdk:"pq"`
	...
	Sasl                      *InputKafkaAuthentication                    `tfsdk:"sasl"`
