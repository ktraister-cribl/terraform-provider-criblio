...
type OutputCriblHTTP struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderCriblHTTP      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsCriblHTTP            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingCriblHTTP `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String                  `tfsdk:"safe_headers"`
	Status                        *TFStatus                       `tfsdk:"status"`
	Streamtags                    []types.String                  `tfsdk:"streamtags"`
	SystemFields                  []types.String                  `tfsdk:"system_fields"`
	TimeoutRetrySettings          *TimeoutRetrySettingsCriblHTTP  `tfsdk:"timeout_retry_settings"`
	TimeoutSec                    types.Float64                   `tfsdk:"timeout_sec"`
	TLS                           *TLSSettingsClientSideCriblHTTP `tfsdk:"tls"`
	TokenTTLMinutes               types.Float64                   `tfsdk:"token_ttl_minutes"`
	Type                          types.String                    `tfsdk:"type"`
	URL                           types.String                    `tfsdk:"url"`
	Urls                          []URLCriblHTTP                  `tfsdk:"urls"`
