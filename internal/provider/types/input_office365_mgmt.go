...
type InputOffice365Mgmt struct {
	...
	Connections         []ConnectionOffice365Mgmt    `tfsdk:"connections"`
	ContentConfig       []ContentConfigOffice365Mgmt `tfsdk:"content_config"`
	...
	Metadata            []MetadatumOffice365Mgmt     `tfsdk:"metadata"`
	Pipeline            types.String                 `tfsdk:"pipeline"`
	PlanType            types.String                 `tfsdk:"plan_type"`
	Pq                  *PqOffice365Mgmt             `tfsdk:"pq"`
	PqEnabled           types.Bool                   `tfsdk:"pq_enabled"`
	PublisherIdentifier types.String                 `tfsdk:"publisher_identifier"`
	RetryRules          *RetryRulesOffice365Mgmt     `tfsdk:"retry_rules"`
