...
type OutputElasticCloud struct {
	Auth                          *AuthElasticCloud                  `tfsdk:"auth"`
	Compress                      types.Bool                         `tfsdk:"compress"`
	Concurrency                   types.Float64                      `tfsdk:"concurrency"`
	Description                   types.String                       `tfsdk:"description"`
	ElasticPipeline               types.String                       `tfsdk:"elastic_pipeline"`
	Environment                   types.String                       `tfsdk:"environment"`
	ExtraHTTPHeaders              []ExtraHTTPHeaderElasticCloud      `tfsdk:"extra_http_headers"`
	ExtraParams                   []ExtraParamElasticCloud           `tfsdk:"extra_params"`
	...
	PqControls                    *PqControlsElasticCloud            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingElasticCloud `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String                     `tfsdk:"safe_headers"`
	Status                        *TFStatus                          `tfsdk:"status"`
	Streamtags                    []types.String                     `tfsdk:"streamtags"`
	SystemFields                  []types.String                     `tfsdk:"system_fields"`
	TimeoutRetrySettings          *TimeoutRetrySettingsElasticCloud  `tfsdk:"timeout_retry_settings"`
