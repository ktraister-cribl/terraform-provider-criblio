...
type OutputDynatraceHTTP struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderDynatraceHTTP      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsDynatraceHTTP            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingDynatraceHTTP `tfsdk:"response_retry_settings"`
	...
	TimeoutRetrySettings          *TimeoutRetrySettingsDynatraceHTTP  `tfsdk:"timeout_retry_settings"`
