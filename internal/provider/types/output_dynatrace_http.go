...
type OutputDynatraceHTTP struct {
	...
	ExtraHTTPHeaders              []OutputDynatraceHTTPExtraHTTPHeader      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *OutputDynatraceHTTPPqControls            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []OutputDynatraceHTTPResponseRetrySetting `tfsdk:"response_retry_settings"`
