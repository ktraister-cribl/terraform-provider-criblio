...
type OutputAzureDataExplorer struct {
	...
	Certificate                   *CertificateAzureDataExplorer           `tfsdk:"certificate"`
	...
	PqControls                    *PqControlsAzureDataExplorer            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingAzureDataExplorer `tfsdk:"response_retry_settings"`
	...
	TimeoutRetrySettings          *TimeoutRetrySettingsAzureDataExplorer  `tfsdk:"timeout_retry_settings"`
