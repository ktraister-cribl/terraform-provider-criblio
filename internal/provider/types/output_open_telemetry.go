...
type OutputOpenTelemetry struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderOpenTelemetry      `tfsdk:"extra_http_headers"`
	...
	Metadata                      []OutputMetadatumOpenTelemetry      `tfsdk:"metadata"`
	OauthHeaders                  []OutputOauthHeaderOpenTelemetry    `tfsdk:"oauth_headers"`
	OauthParams                   []OutputOauthParamOpenTelemetry     `tfsdk:"oauth_params"`
	...
	PqControls                    *PqControlsOpenTelemetry            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingOpenTelemetry `tfsdk:"response_retry_settings"`
	...
	TimeoutRetrySettings          *TimeoutRetrySettingsOpenTelemetry  `tfsdk:"timeout_retry_settings"`
	TimeoutSec                    types.Float64                       `tfsdk:"timeout_sec"`
	TLS                           *TLSSettingsClientSideOpenTelemetry `tfsdk:"tls"`
