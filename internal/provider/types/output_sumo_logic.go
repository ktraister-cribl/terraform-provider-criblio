...
type OutputSumoLogic struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderSumoLogic      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsSumoLogic            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingSumoLogic `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String                  `tfsdk:"safe_headers"`
	Status                        *TFStatus                       `tfsdk:"status"`
	Streamtags                    []types.String                  `tfsdk:"streamtags"`
	SystemFields                  []types.String                  `tfsdk:"system_fields"`
	TimeoutRetrySettings          *TimeoutRetrySettingsSumoLogic  `tfsdk:"timeout_retry_settings"`
