...
type OutputSumoLogic struct {
	...
	ExtraHTTPHeaders              []OutputSumoLogicExtraHTTPHeader      `tfsdk:"extra_http_headers"`
	...
	ResponseRetrySettings         []OutputSumoLogicResponseRetrySetting `tfsdk:"response_retry_settings"`
