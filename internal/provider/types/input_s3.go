...
type InputS3 struct {
	...
	Checkpointing               *CheckpointingS3 `tfsdk:"checkpointing"`
	Connections                 []ConnectionS3   `tfsdk:"connections"`
	...
	Metadata                    []MetadatumS3    `tfsdk:"metadata"`
	...
	Preprocess                  *PreprocessS3    `tfsdk:"preprocess"`
