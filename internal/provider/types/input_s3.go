...
type InputS3 struct {
	...
	Checkpointing               *InputS3Checkpointing `tfsdk:"checkpointing"`
	Connections                 []InputS3Connection   `tfsdk:"connections"`
	...
	Metadata                    []InputS3Metadatum    `tfsdk:"metadata"`
	...
	TagAfterProcessing          types.Bool            `tfsdk:"tag_after_processing"`
