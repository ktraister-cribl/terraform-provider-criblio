...
type InputSplunk struct {
	AuthTokens          []AuthTokenSplunk            `tfsdk:"auth_tokens"`
	BreakerRulesets     []types.String               `tfsdk:"breaker_rulesets"`
	Compress            types.String                 `tfsdk:"compress"`
	Connections         []ConnectionSplunk           `tfsdk:"connections"`
	...
	Metadata            []MetadatumSplunk            `tfsdk:"metadata"`
	Pipeline            types.String                 `tfsdk:"pipeline"`
	Port                types.Float64                `tfsdk:"port"`
	Pq                  *PqSplunk                    `tfsdk:"pq"`
	...
	TLS                 *TLSSettingsServerSideSplunk `tfsdk:"tls"`
