...
type InputSplunkSearch struct {
	...
	Connections         []ConnectionSplunkSearch  `tfsdk:"connections"`
	...
	Metadata            []MetadatumSplunkSearch   `tfsdk:"metadata"`
	OauthHeaders        []OauthHeaderSplunkSearch `tfsdk:"oauth_headers"`
	OauthParams         []OauthParamSplunkSearch  `tfsdk:"oauth_params"`
	OutputMode          types.String              `tfsdk:"output_mode"`
	Password            types.String              `tfsdk:"password"`
	Pipeline            types.String              `tfsdk:"pipeline"`
	Pq                  *PqSplunkSearch           `tfsdk:"pq"`
	PqEnabled           types.Bool                `tfsdk:"pq_enabled"`
	RejectUnauthorized  types.Bool                `tfsdk:"reject_unauthorized"`
	RequestTimeout      types.Float64             `tfsdk:"request_timeout"`
	RetryRules          *RetryRulesSplunkSearch   `tfsdk:"retry_rules"`
