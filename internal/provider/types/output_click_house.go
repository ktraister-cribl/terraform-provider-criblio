...
type OutputClickHouse struct {
	...
	ColumnMappings                []OutputColumnMapping            `tfsdk:"column_mappings"`
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderClickHouse      `tfsdk:"extra_http_headers"`
	...
	OauthHeaders                  []OauthHeaderClickHouse          `tfsdk:"oauth_headers"`
	OauthParams                   []OauthParamClickHouse           `tfsdk:"oauth_params"`
	OnBackpressure                types.String                     `tfsdk:"on_backpressure"`
	Password                      types.String                     `tfsdk:"password"`
	Pipeline                      types.String                     `tfsdk:"pipeline"`
	PqCompress                    types.String                     `tfsdk:"pq_compress"`
	PqControls                    *PqControlsClickHouse            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingClickHouse `tfsdk:"response_retry_settings"`
	...
	TimeoutRetrySettings          *TimeoutRetrySettingsClickHouse  `tfsdk:"timeout_retry_settings"`
	TimeoutSec                    types.Float64                    `tfsdk:"timeout_sec"`
	TLS                           *TLSSettingsClientSideClickHouse `tfsdk:"tls"`
