...
type OutputWebhook struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderWebhook      `tfsdk:"extra_http_headers"`
	...
	OauthHeaders                  []OauthHeaderWebhook          `tfsdk:"oauth_headers"`
	OauthParams                   []OauthParamWebhook           `tfsdk:"oauth_params"`
	OnBackpressure                types.String                  `tfsdk:"on_backpressure"`
	Password                      types.String                  `tfsdk:"password"`
	Pipeline                      types.String                  `tfsdk:"pipeline"`
	PqCompress                    types.String                  `tfsdk:"pq_compress"`
	PqControls                    *PqControlsWebhook            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingWebhook `tfsdk:"response_retry_settings"`
	...
	TimeoutRetrySettings          *TimeoutRetrySettingsWebhook  `tfsdk:"timeout_retry_settings"`
	TimeoutSec                    types.Float64                 `tfsdk:"timeout_sec"`
	TLS                           *TLSSettingsClientSideWebhook `tfsdk:"tls"`
