...
type InputSyslogSyslog1 struct {
	...
	Connections                      []InputSyslogConnection1           `tfsdk:"connections"`
	...
	Metadata                         []InputSyslogMetadatum1            `tfsdk:"metadata"`
	OctetCounting                    types.Bool                         `tfsdk:"octet_counting"`
	Pipeline                         types.String                       `tfsdk:"pipeline"`
	Pq                               *InputSyslogPq1                    `tfsdk:"pq"`
	...
	TLS                              *InputSyslogTLSSettingsServerSide1 `tfsdk:"tls"`
