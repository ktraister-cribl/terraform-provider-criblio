...
type OutputWavefront struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderWavefront      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsWavefront            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingWavefront `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String                  `tfsdk:"safe_headers"`
	Status                        *TFStatus                       `tfsdk:"status"`
	Streamtags                    []types.String                  `tfsdk:"streamtags"`
	SystemFields                  []types.String                  `tfsdk:"system_fields"`
	TextSecret                    types.String                    `tfsdk:"text_secret"`
	TimeoutRetrySettings          *TimeoutRetrySettingsWavefront  `tfsdk:"timeout_retry_settings"`
