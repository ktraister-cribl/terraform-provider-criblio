...
type OutputWavefront struct {
	...
	ExtraHTTPHeaders              []OutputWavefrontExtraHTTPHeader      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *OutputWavefrontPqControls            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []OutputWavefrontResponseRetrySetting `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String                        `tfsdk:"safe_headers"`
	Streamtags                    []types.String                        `tfsdk:"streamtags"`
	SystemFields                  []types.String                        `tfsdk:"system_fields"`
	TextSecret                    types.String                          `tfsdk:"text_secret"`
	TimeoutRetrySettings          *OutputWavefrontTimeoutRetrySettings  `tfsdk:"timeout_retry_settings"`
