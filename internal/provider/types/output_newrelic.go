...
type OutputNewrelic struct {
	...
	ExtraHTTPHeaders              []OutputNewrelicExtraHTTPHeader      `tfsdk:"extra_http_headers"`
	...
	Metadata                      []OutputNewrelicMetadatum            `tfsdk:"metadata"`
	...
	ResponseRetrySettings         []OutputNewrelicResponseRetrySetting `tfsdk:"response_retry_settings"`
