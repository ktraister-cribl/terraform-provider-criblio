...
type OutputNewrelic struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderNewrelic      `tfsdk:"extra_http_headers"`
	...
	ResponseRetrySettings         []ResponseRetrySettingNewrelic `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String                 `tfsdk:"safe_headers"`
	Status                        *TFStatus                      `tfsdk:"status"`
	Streamtags                    []types.String                 `tfsdk:"streamtags"`
	SystemFields                  []types.String                 `tfsdk:"system_fields"`
	TextSecret                    types.String                   `tfsdk:"text_secret"`
	TimeoutRetrySettings          *TimeoutRetrySettingsNewrelic  `tfsdk:"timeout_retry_settings"`
