...
type OutputAzureLogs struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderAzureLogs      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsAzureLogs            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingAzureLogs `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String                  `tfsdk:"safe_headers"`
	Status                        *TFStatus                       `tfsdk:"status"`
	Streamtags                    []types.String                  `tfsdk:"streamtags"`
	SystemFields                  []types.String                  `tfsdk:"system_fields"`
	TimeoutRetrySettings          *TimeoutRetrySettingsAzureLogs  `tfsdk:"timeout_retry_settings"`
