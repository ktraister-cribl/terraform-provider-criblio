...
type InputZscalerHec struct {
	...
	AuthTokens                []AuthTokenZscalerHec            `tfsdk:"auth_tokens"`
	CaptureHeaders            types.Bool                       `tfsdk:"capture_headers"`
	Connections               []ConnectionZscalerHec           `tfsdk:"connections"`
	...
	Metadata                  []MetadatumZscalerHec            `tfsdk:"metadata"`
	Pipeline                  types.String                     `tfsdk:"pipeline"`
	Port                      types.Float64                    `tfsdk:"port"`
	Pq                        *PqZscalerHec                    `tfsdk:"pq"`
	...
	TLS                       *TLSSettingsServerSideZscalerHec `tfsdk:"tls"`
