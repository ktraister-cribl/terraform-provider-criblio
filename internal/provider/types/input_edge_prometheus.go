...
type InputEdgePrometheus struct {
	...
	Connections             []ConnectionEdgePrometheus   `tfsdk:"connections"`
	...
	Metadata                []MetadatumEdgePrometheus    `tfsdk:"metadata"`
	NameList                []types.String               `tfsdk:"name_list"`
	Password                types.String                 `tfsdk:"password"`
	Persistence             *DiskSpoolingEdgePrometheus  `tfsdk:"persistence"`
	Pipeline                types.String                 `tfsdk:"pipeline"`
	PodFilter               []PodFilter                  `tfsdk:"pod_filter"`
	Pq                      *PqEdgePrometheus            `tfsdk:"pq"`
	...
	SearchFilter            []SearchFilterEdgePrometheus `tfsdk:"search_filter"`
