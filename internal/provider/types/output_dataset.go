...
type OutputDataset struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderDataset      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsDataset            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingDataset `tfsdk:"response_retry_settings"`
	...
	TimeoutRetrySettings          *TimeoutRetrySettingsDataset  `tfsdk:"timeout_retry_settings"`
