...
type OutputSignalfx struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderSignalfx      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsSignalfx            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingSignalfx `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String                 `tfsdk:"safe_headers"`
	Status                        *TFStatus                      `tfsdk:"status"`
	Streamtags                    []types.String                 `tfsdk:"streamtags"`
	SystemFields                  []types.String                 `tfsdk:"system_fields"`
	TextSecret                    types.String                   `tfsdk:"text_secret"`
	TimeoutRetrySettings          *TimeoutRetrySettingsSignalfx  `tfsdk:"timeout_retry_settings"`
