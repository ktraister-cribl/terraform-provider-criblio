...
type OutputSignalfx struct {
	...
	ExtraHTTPHeaders              []OutputSignalfxExtraHTTPHeader      `tfsdk:"extra_http_headers"`
	...
	ResponseRetrySettings         []OutputSignalfxResponseRetrySetting `tfsdk:"response_retry_settings"`
