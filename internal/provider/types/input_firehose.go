...
type InputFirehose struct {
	...
	Connections           []InputFirehoseConnection           `tfsdk:"connections"`
	...
	Metadata              []InputFirehoseMetadatum            `tfsdk:"metadata"`
	Pipeline              types.String                        `tfsdk:"pipeline"`
	Port                  types.Float64                       `tfsdk:"port"`
	Pq                    *InputFirehosePq                    `tfsdk:"pq"`
	...
	TLS                   *InputFirehoseTLSSettingsServerSide `tfsdk:"tls"`
