...
type InputFirehose struct {
	...
	Connections           []ConnectionFirehose           `tfsdk:"connections"`
	...
	Metadata              []MetadatumFirehose            `tfsdk:"metadata"`
	Pipeline              types.String                   `tfsdk:"pipeline"`
	Port                  types.Float64                  `tfsdk:"port"`
	Pq                    *PqFirehose                    `tfsdk:"pq"`
	...
	TLS                   *TLSSettingsServerSideFirehose `tfsdk:"tls"`
