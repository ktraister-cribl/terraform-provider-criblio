...
type OutputNewrelicEvents struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderNewrelicEvents      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsNewrelicEvents            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingNewrelicEvents `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String                       `tfsdk:"safe_headers"`
	Status                        *TFStatus                            `tfsdk:"status"`
	Streamtags                    []types.String                       `tfsdk:"streamtags"`
	SystemFields                  []types.String                       `tfsdk:"system_fields"`
	TextSecret                    types.String                         `tfsdk:"text_secret"`
	TimeoutRetrySettings          *TimeoutRetrySettingsNewrelicEvents  `tfsdk:"timeout_retry_settings"`
