...
type InputLoki struct {
	...
	Connections           []ConnectionLoki           `tfsdk:"connections"`
	...
	Metadata              []MetadatumLoki            `tfsdk:"metadata"`
	OauthHeaders          []OauthHeaderLoki          `tfsdk:"oauth_headers"`
	OauthParams           []OauthParamLoki           `tfsdk:"oauth_params"`
	...
	TLS                   *TLSSettingsServerSideLoki `tfsdk:"tls"`
