...
type InputLoki struct {
	...
	Connections           []InputLokiConnection           `tfsdk:"connections"`
	...
	Metadata              []InputLokiMetadatum            `tfsdk:"metadata"`
	OauthHeaders          []InputLokiOauthHeader          `tfsdk:"oauth_headers"`
	OauthParams           []InputLokiOauthParam           `tfsdk:"oauth_params"`
