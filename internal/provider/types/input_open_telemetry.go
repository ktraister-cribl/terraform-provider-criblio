...
type InputOpenTelemetry struct {
	...
	Connections           []ConnectionOpenTelemetry           `tfsdk:"connections"`
	...
	Metadata              []InputMetadatumOpenTelemetry       `tfsdk:"metadata"`
	OauthHeaders          []InputOauthHeaderOpenTelemetry     `tfsdk:"oauth_headers"`
	OauthParams           []InputOauthParamOpenTelemetry      `tfsdk:"oauth_params"`
	OtlpVersion           types.String                        `tfsdk:"otlp_version"`
	Password              types.String                        `tfsdk:"password"`
	Pipeline              types.String                        `tfsdk:"pipeline"`
	Port                  types.Float64                       `tfsdk:"port"`
	Pq                    *PqOpenTelemetry                    `tfsdk:"pq"`
	...
	TLS                   *TLSSettingsServerSideOpenTelemetry `tfsdk:"tls"`
