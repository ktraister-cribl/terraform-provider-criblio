...
type OutputServiceNow struct {
	...
	ExtraHTTPHeaders              []OutputServiceNowExtraHTTPHeader      `tfsdk:"extra_http_headers"`
	...
	Metadata                      []OutputServiceNowMetadatum            `tfsdk:"metadata"`
	...
	PqControls                    *OutputServiceNowPqControls            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []OutputServiceNowResponseRetrySetting `tfsdk:"response_retry_settings"`
