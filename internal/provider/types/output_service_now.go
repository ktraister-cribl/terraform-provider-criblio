...
type OutputServiceNow struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeader131      `tfsdk:"extra_http_headers"`
	...
	Metadata                      []Metadatum131            `tfsdk:"metadata"`
	...
	PqControls                    *PqControls131            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySetting131 `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String            `tfsdk:"safe_headers"`
	Status                        *TFStatus                 `tfsdk:"status"`
	Streamtags                    []types.String            `tfsdk:"streamtags"`
	SystemFields                  []types.String            `tfsdk:"system_fields"`
	TimeoutRetrySettings          *TimeoutRetrySettings131  `tfsdk:"timeout_retry_settings"`
	TimeoutSec                    types.Float64             `tfsdk:"timeout_sec"`
	TLS                           *TLSSettingsClientSide131 `tfsdk:"tls"`
