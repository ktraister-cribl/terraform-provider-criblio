...
type OutputCrowdstrikeNextGenSiem struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderCrowdstrikeNextGenSiem      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsCrowdstrikeNextGenSiem            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingCrowdstrikeNextGenSiem `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String                               `tfsdk:"safe_headers"`
	Status                        *TFStatus                                    `tfsdk:"status"`
	Streamtags                    []types.String                               `tfsdk:"streamtags"`
	SystemFields                  []types.String                               `tfsdk:"system_fields"`
	TextSecret                    types.String                                 `tfsdk:"text_secret"`
	TimeoutRetrySettings          *TimeoutRetrySettingsCrowdstrikeNextGenSiem  `tfsdk:"timeout_retry_settings"`
