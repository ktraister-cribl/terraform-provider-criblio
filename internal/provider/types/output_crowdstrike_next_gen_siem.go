...
type OutputCrowdstrikeNextGenSiem struct {
	...
	ExtraHTTPHeaders              []OutputCrowdstrikeNextGenSiemExtraHTTPHeader      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *OutputCrowdstrikeNextGenSiemPqControls            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []OutputCrowdstrikeNextGenSiemResponseRetrySetting `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String                                     `tfsdk:"safe_headers"`
	Streamtags                    []types.String                                     `tfsdk:"streamtags"`
	SystemFields                  []types.String                                     `tfsdk:"system_fields"`
	TextSecret                    types.String                                       `tfsdk:"text_secret"`
	TimeoutRetrySettings          *OutputCrowdstrikeNextGenSiemTimeoutRetrySettings  `tfsdk:"timeout_retry_settings"`
