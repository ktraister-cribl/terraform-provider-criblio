...
type OutputSentinel struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderSentinel      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsSentinel            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingSentinel `tfsdk:"response_retry_settings"`
	...
	TimeoutRetrySettings          *TimeoutRetrySettingsSentinel  `tfsdk:"timeout_retry_settings"`
