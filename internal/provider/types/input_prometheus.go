...
type InputPrometheus struct {
	...
	Connections             []ConnectionPrometheus   `tfsdk:"connections"`
	...
	Metadata                []MetadatumPrometheus    `tfsdk:"metadata"`
	NameList                []types.String           `tfsdk:"name_list"`
	Password                types.String             `tfsdk:"password"`
	Pipeline                types.String             `tfsdk:"pipeline"`
	Pq                      *PqPrometheus            `tfsdk:"pq"`
	...
	SearchFilter            []SearchFilterPrometheus `tfsdk:"search_filter"`
