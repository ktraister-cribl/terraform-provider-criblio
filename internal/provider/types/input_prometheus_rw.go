...
type InputPrometheusRw struct {
	...
	Connections           []ConnectionPrometheusRw           `tfsdk:"connections"`
	...
	Metadata              []MetadatumPrometheusRw            `tfsdk:"metadata"`
	OauthHeaders          []OauthHeaderPrometheusRw          `tfsdk:"oauth_headers"`
	OauthParams           []OauthParamPrometheusRw           `tfsdk:"oauth_params"`
	Password              types.String                       `tfsdk:"password"`
	Pipeline              types.String                       `tfsdk:"pipeline"`
	Port                  types.Float64                      `tfsdk:"port"`
	Pq                    *PqPrometheusRw                    `tfsdk:"pq"`
	...
	TLS                   *TLSSettingsServerSidePrometheusRw `tfsdk:"tls"`
