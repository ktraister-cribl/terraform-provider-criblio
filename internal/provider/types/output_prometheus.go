...
type OutputPrometheus struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderPrometheus      `tfsdk:"extra_http_headers"`
	...
	OauthHeaders                  []OauthHeaderPrometheus          `tfsdk:"oauth_headers"`
	OauthParams                   []OauthParamPrometheus           `tfsdk:"oauth_params"`
	OnBackpressure                types.String                     `tfsdk:"on_backpressure"`
	Password                      types.String                     `tfsdk:"password"`
	Pipeline                      types.String                     `tfsdk:"pipeline"`
	PqCompress                    types.String                     `tfsdk:"pq_compress"`
	PqControls                    *PqControlsPrometheus            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingPrometheus `tfsdk:"response_retry_settings"`
	...
	TimeoutRetrySettings          *TimeoutRetrySettingsPrometheus  `tfsdk:"timeout_retry_settings"`
