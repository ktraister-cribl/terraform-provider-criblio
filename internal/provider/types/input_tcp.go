...
type InputTCP struct {
	...
	Connections         []ConnectionTCP           `tfsdk:"connections"`
	...
	Metadata            []MetadatumTCP            `tfsdk:"metadata"`
	Pipeline            types.String              `tfsdk:"pipeline"`
	Port                types.Float64             `tfsdk:"port"`
	Pq                  *PqTCP                    `tfsdk:"pq"`
	PqEnabled           types.Bool                `tfsdk:"pq_enabled"`
	Preprocess          *PreprocessTCP            `tfsdk:"preprocess"`
	...
	TLS                 *TLSSettingsServerSideTCP `tfsdk:"tls"`
