...
type InputElastic struct {
	...
	Connections           []ConnectionElastic           `tfsdk:"connections"`
	...
	ExtraHTTPHeaders      []InputExtraHTTPHeader        `tfsdk:"extra_http_headers"`
	...
	Metadata              []MetadatumElastic            `tfsdk:"metadata"`
	Password              types.String                  `tfsdk:"password"`
	Pipeline              types.String                  `tfsdk:"pipeline"`
	Port                  types.Float64                 `tfsdk:"port"`
	Pq                    *PqElastic                    `tfsdk:"pq"`
	PqEnabled             types.Bool                    `tfsdk:"pq_enabled"`
	ProxyMode             *ProxyModeElastic             `tfsdk:"proxy_mode"`
	RequestTimeout        types.Float64                 `tfsdk:"request_timeout"`
	SendToRoutes          types.Bool                    `tfsdk:"send_to_routes"`
	SocketTimeout         types.Float64                 `tfsdk:"socket_timeout"`
	Status                *TFStatus                     `tfsdk:"status"`
	Streamtags            []types.String                `tfsdk:"streamtags"`
	TLS                   *TLSSettingsServerSideElastic `tfsdk:"tls"`
