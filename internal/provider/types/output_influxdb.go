...
type OutputInfluxdb struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderInfluxdb      `tfsdk:"extra_http_headers"`
	...
	OauthHeaders                  []OauthHeaderInfluxdb          `tfsdk:"oauth_headers"`
	OauthParams                   []OauthParamInfluxdb           `tfsdk:"oauth_params"`
	OnBackpressure                types.String                   `tfsdk:"on_backpressure"`
	Org                           types.String                   `tfsdk:"org"`
	Password                      types.String                   `tfsdk:"password"`
	Pipeline                      types.String                   `tfsdk:"pipeline"`
	PqCompress                    types.String                   `tfsdk:"pq_compress"`
	PqControls                    *PqControlsInfluxdb            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingInfluxdb `tfsdk:"response_retry_settings"`
	...
	TimeoutRetrySettings          *TimeoutRetrySettingsInfluxdb  `tfsdk:"timeout_retry_settings"`
