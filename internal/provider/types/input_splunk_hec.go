...
type InputSplunkHec struct {
	...
	Metadata                  []MetadatumSplunkHec            `tfsdk:"metadata"`
	Pipeline                  types.String                    `tfsdk:"pipeline"`
	Port                      types.Float64                   `tfsdk:"port"`
	Pq                        *PqSplunkHec                    `tfsdk:"pq"`
	...
	TLS                       *TLSSettingsServerSideSplunkHec `tfsdk:"tls"`
