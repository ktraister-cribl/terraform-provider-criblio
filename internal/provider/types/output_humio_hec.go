...
type OutputHumioHec struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderHumioHec      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsHumioHec            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingHumioHec `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String                 `tfsdk:"safe_headers"`
	Status                        *TFStatus                      `tfsdk:"status"`
	Streamtags                    []types.String                 `tfsdk:"streamtags"`
	SystemFields                  []types.String                 `tfsdk:"system_fields"`
	TextSecret                    types.String                   `tfsdk:"text_secret"`
	TimeoutRetrySettings          *TimeoutRetrySettingsHumioHec  `tfsdk:"timeout_retry_settings"`
