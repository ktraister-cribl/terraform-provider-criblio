...
type InputS3Inventory struct {
	...
	Checkpointing               *CheckpointingS3Inventory `tfsdk:"checkpointing"`
	ChecksumSuffix              types.String              `tfsdk:"checksum_suffix"`
	Connections                 []ConnectionS3Inventory   `tfsdk:"connections"`
	...
	Metadata                    []MetadatumS3Inventory    `tfsdk:"metadata"`
	...
	Pq                          *PqS3Inventory            `tfsdk:"pq"`
	PqEnabled                   types.Bool                `tfsdk:"pq_enabled"`
	Preprocess                  *PreprocessS3Inventory    `tfsdk:"preprocess"`
