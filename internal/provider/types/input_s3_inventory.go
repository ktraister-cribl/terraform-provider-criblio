...
type InputS3Inventory struct {
	...
	Checkpointing               *InputS3InventoryCheckpointing `tfsdk:"checkpointing"`
	ChecksumSuffix              types.String                   `tfsdk:"checksum_suffix"`
	Connections                 []InputS3InventoryConnection   `tfsdk:"connections"`
	...
	Metadata                    []InputS3InventoryMetadatum    `tfsdk:"metadata"`
