...
type InputAzureBlob struct {
	...
	Certificate                 *InputCertificate     `tfsdk:"certificate"`
	ClientID                    types.String          `tfsdk:"client_id"`
	ClientTextSecret            types.String          `tfsdk:"client_text_secret"`
	Connections                 []ConnectionAzureBlob `tfsdk:"connections"`
	...
	Metadata                    []MetadatumAzureBlob  `tfsdk:"metadata"`
