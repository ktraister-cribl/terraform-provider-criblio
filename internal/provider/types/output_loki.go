...
type OutputLoki struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderLoki      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsLoki            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingLoki `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String             `tfsdk:"safe_headers"`
	Status                        *TFStatus                  `tfsdk:"status"`
	Streamtags                    []types.String             `tfsdk:"streamtags"`
	SystemFields                  []types.String             `tfsdk:"system_fields"`
	TextSecret                    types.String               `tfsdk:"text_secret"`
	TimeoutRetrySettings          *TimeoutRetrySettingsLoki  `tfsdk:"timeout_retry_settings"`
