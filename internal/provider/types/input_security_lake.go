...
type InputSecurityLake struct {
	...
	Checkpointing               *CheckpointingSecurityLake `tfsdk:"checkpointing"`
	Connections                 []ConnectionSecurityLake   `tfsdk:"connections"`
	...
	Metadata                    []MetadatumSecurityLake    `tfsdk:"metadata"`
	...
	Pq                          *PqSecurityLake            `tfsdk:"pq"`
	PqEnabled                   types.Bool                 `tfsdk:"pq_enabled"`
	Preprocess                  *PreprocessSecurityLake    `tfsdk:"preprocess"`
