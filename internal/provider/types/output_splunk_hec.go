...
type OutputSplunkHec struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderSplunkHec      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsSplunkHec            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingSplunkHec `tfsdk:"response_retry_settings"`
	...
	TimeoutRetrySettings          *TimeoutRetrySettingsSplunkHec  `tfsdk:"timeout_retry_settings"`
	TimeoutSec                    types.Float64                   `tfsdk:"timeout_sec"`
	Token                         types.String                    `tfsdk:"token"`
	Type                          types.String                    `tfsdk:"type"`
	URL                           types.String                    `tfsdk:"url"`
	Urls                          []URLSplunkHec                  `tfsdk:"urls"`
