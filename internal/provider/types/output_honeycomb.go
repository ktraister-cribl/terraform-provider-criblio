...
type OutputHoneycomb struct {
	...
	ExtraHTTPHeaders              []ExtraHTTPHeaderHoneycomb      `tfsdk:"extra_http_headers"`
	...
	PqControls                    *PqControlsHoneycomb            `tfsdk:"pq_controls"`
	...
	ResponseRetrySettings         []ResponseRetrySettingHoneycomb `tfsdk:"response_retry_settings"`
	...
	TimeoutRetrySettings          *TimeoutRetrySettingsHoneycomb  `tfsdk:"timeout_retry_settings"`
