...
func (r *PackRoutesDataSourceModel) RefreshFromOperationsGetRoutesByPackResponseBody(ctx context.Context, resp *operations.GetRoutesByPackResponseBody) diag.Diagnostics {
