...
func (r *PackSourceResourceModel) ToOperationsDeleteSystemInputsByPackRequest(ctx context.Context) (*operations.DeleteSystemInputsByPackRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PackSourceResourceModel) ToOperationsUpdateSystemInputsByPackRequest(ctx context.Context) (*operations.UpdateSystemInputsByPackRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PackSourceResourceModel) ToSharedInput(ctx context.Context) (*shared.Input, diag.Diagnostics) {
	var diags diag.Diagnostics
