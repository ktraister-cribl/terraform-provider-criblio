...
locals {
  ...
  # Field mappings specific to splunk_hec (comprehensive from schema)
  field_mappings = {
    # Splunk HEC specific mappings
    "authType"                      = "auth_type"
    "dnsResolvePeriodSec"           = "dns_resolve_period_sec"
    "enableMultiMetrics"            = "enable_multi_metrics"
  ...
  direct_fields = ["id", "description", "disabled", "environment", "pipeline", "streamtags", "urls", "url", "token"]
