...
locals {
  ...
  # Field mappings specific to elasticsearch (comprehensive from schema)
  field_mappings = {
    # Elasticsearch specific mappings
    "dnsResolvePeriodSec"           = "dns_resolve_period_sec"
    "docType"                       = "doc_type"
    "elasticPipeline"               = "elastic_pipeline"
  ...
  direct_fields = ["id", "description", "disabled", "environment", "pipeline", "streamtags", "index", "type", "compress", "concurrency", "url", "urls"]
