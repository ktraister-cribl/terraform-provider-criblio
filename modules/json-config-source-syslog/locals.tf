...
locals {
  ...
  field_mappings = {
    ...
    "singleMsgUdpPackets"              = "single_msg_udp_packets"
    "socketEndingMaxWait"              = "socket_ending_max_wait"
    "socketIdleTimeout"                = "socket_idle_timeout"
    "socketMaxLifespan"                = "socket_max_lifespan"
    "udpSocketRxBufSize"               = "udp_socket_rx_buf_size"
    "strictlyInferOctetCounting"       = "strictly_infer_octet_counting"
    "allowNonStandardAppName"          = "allow_non_standard_app_name"
    "inferFraming"                     = "infer_framing"
    "keepFieldsList"                   = "keep_fields_list"
    "maxBufferSize"                    = "max_buffer_size"
    "maxActiveCxn"                     = "max_active_cxn"
    "octetCounting"                    = "octet_counting"
    "enableEnhancedProxyHeaderParsing" = "enable_enhanced_proxy_header_parsing"
    "enableLoadBalancing"              = "enable_load_balancing"
