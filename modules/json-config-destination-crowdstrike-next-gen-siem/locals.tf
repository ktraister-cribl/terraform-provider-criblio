...
locals {
  ...
  # Field mappings specific to crowdstrike_next_gen_siem
  field_mappings = {
  ...
  direct_fields = ["id", "description", "disabled", "environment", "pipeline", "streamtags", "type", "url", "compress", "concurrency", "format", "token"]
