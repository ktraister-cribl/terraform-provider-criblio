...
locals {
  ...
  # Field mappings specific to prometheus
  field_mappings = {
    # Prometheus specific mappings
    ...
    "metricRenameExpr"              = "metric_rename_expr"
    "metricsFlushPeriodSec"         = "metrics_flush_period_sec"
    ...
    "secretParamName"               = "secret_param_name"
  ...
  direct_fields = ["id", "description", "disabled", "environment", "pipeline", "streamtags", "type", "url", "concurrency", "password", "secret", "username"]
